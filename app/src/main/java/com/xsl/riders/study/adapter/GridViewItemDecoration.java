 ...
 *
 * @author:xsl Date:2017/12/23,Time:12:51
 * Description:
 */
...
//        }
     ...
     */
    public GridViewItemDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public GridViewItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
