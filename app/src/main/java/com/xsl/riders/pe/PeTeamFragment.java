...
public class PeTeamFragment extends LazyFragment {
    private static PeTeamFragment mInstance;
    ...
    public static PeTeamFragment newInstance() {
        synchronized (PeTeamFragment.class) {
            if (mInstance == null) {
                mInstance = new PeTeamFragment();
            }
            return mInstance;
        }
    }
    ...
    protected void initView(View view) {
        ...
        mPeBeanAdapter = new PeBeanAdapter(mContext, mItemList,"私教团队详情");
