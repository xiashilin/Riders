...
public class PeFragment extends LazyFragment {
    private static PeFragment mInstance;
    ...
    public static PeFragment newInstance() {
        synchronized (PeFragment.class) {
            if (mInstance == null) {
                mInstance = new PeFragment();
            }
            return mInstance;
        }
    }
